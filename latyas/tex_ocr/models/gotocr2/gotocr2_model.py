...
from latyas.tex_ocr.models.texocr_model import TexOCRModel
from .gotocr2_config import GOTOCR2TexOCRConfig

from transformers import AutoModel, AutoTokenizer


class GOTOCR2TexOCRModel(TexOCRModel):
    def __init__(self, config: GOTOCR2TexOCRConfig) -> None:
        self.config = config
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        config = GOTOCR2TexOCRConfig.from_pretrained(pretrained_model_name_or_path)
