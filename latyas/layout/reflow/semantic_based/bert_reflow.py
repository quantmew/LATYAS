...
from latyas.layout.reflow.position_based import position_reflow


def bert_reflow(page_layout: Layout, threshold=3) -> List[int]:
    position_blocks = position_reflow(page_layout)
