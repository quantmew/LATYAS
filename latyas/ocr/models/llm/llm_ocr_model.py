...
from .llm_ocr_config import LargeLanguageModelOCRConfig


class LargeLanguageModelOCRModel(OCRModel):
    def __init__(self, config: LargeLanguageModelOCRConfig) -> None:
        self.config = config
    ...
    def from_pretrained(
        ...
        revision: str = "main",
        **kwargs,
    ) -> "LargeLanguageModelOCRModel":
        config = LargeLanguageModelOCRConfig.from_pretrained(pretrained_model_name_or_path)
