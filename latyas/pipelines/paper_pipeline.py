...
class PaperPipeline(BasePipeline):
    def __init__(self) -> None:
        ...
        self.add_layout_model("layout_texteller", TexTellerLayoutModel.from_pretrained("XiaHan19/texteller_rtdetr_r50vd_6x_coco"))
        
        
        self.add_ocr_model("ocr_paddle", PaddleOCRModel(PaddleOCRConfig()))
        self.add_ocr_model("ocr_texteller", TexTellerOCRModel.from_pretrained("OleehyO/TexTeller"))
